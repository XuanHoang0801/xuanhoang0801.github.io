      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h3>Thêm trạng thái đơn hàng</h3>
          </div>
            ...
            <div class="table-responsive p-0">
                <form action="/admin/trang-thai" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name" placeholder="Nhập tên trạng thái đơn hàng..." class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}">
                      @error('name')
