...
@section('url','/ banner / '.$banner->title.'')
@section('content')
            ...
            <div class="table-responsive p-0">
                <form action="/admin/banner/{{$banner->id}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name" id="" class="form-control @error('name') is-invalid @enderror" placeholder="Nhập tiêu đề..." value="{{$banner->title}}{{ old('name')}}">
                    ...
                    <div class="form-group">
                      ...
                      <p class="text-danger mt-3 text-sm">{{ $message }}</p>
                      @enderror
                      <img src="/assets/img/banner/{{$banner->image}}" alt="" srcset="" width="100" id="image" class="mt-3">
                    </div>
                    <div class="form-group d-flex">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" name="show" 
                          @if ($banner->status ==1)
                            checked>
                          @else  
                          @endif
