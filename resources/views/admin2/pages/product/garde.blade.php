                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class=" d-flex justify-content-center text-sm">
                        <a href="admin/quan-ly-san-pham/khoi-phuc/{{$item->id}}" class="btn btn-success  " onclick="return confirm('Bạn có chắc hắn muốn khôi phục sản phẩm này không!')"><i class="fas fa-undo"></i></a>
