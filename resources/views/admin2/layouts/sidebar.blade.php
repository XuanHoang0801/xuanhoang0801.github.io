<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">HitShop</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link 
          @if($url == route('danh-muc.index'))
          active
          @endif
          @if($url == route('danh-muc.create'))
          active
          @endif
        ...
        <li class="nav-item">
          <a class="nav-link 
          @if($url == route('nha-san-xuat.index'))
          active
          @endif
          @if($url == route('nha-san-xuat.create'))
          active
          @endif
          @if($url =='nha-san-xuat')
          active
          ...
          " href="/admin/nha-san-xuat">
            ...
            <span class="nav-link-text ms-1">Nhà sản xuất</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  
          @if($url == route('quan-ly-san-pham.index'))
          active
          @endif
          @if($url == route('quan-ly-san-pham.create'))
          active
          @endif
          @if($url == route('quan-ly-san-pham.da-xoa'))
          active
          @endif
        ...
        <li class="nav-item">
          <a class="nav-link 
          @if($url == route('quan-ly-bai-viet.index'))
          active
          @endif
          @if($url == route('quan-ly-bai-viet.create'))
          active
          @endif
          @if($url == route('quan-ly-bai-viet.da-xoa'))
          active
          @endif
        ...
        <li class="nav-item">
          <a class="nav-link 
          @if($url == route('quan-ly-don-hang.index'))
          active
          @endif
          @if($url == route('quan-ly-don-hang.don-huy'))
          active
          @endif
        ...
        <li class="nav-item">
          <a class="nav-link  
          @if($url == route('khach-hang.index'))
          active
          @endif
          @if($url == route('trang-thai.create'))
          active
          @endif
          {{-- @if($url == route('quan-ly-bai-viet.da-xoa'))
          active
        ...
        <li class="nav-item">
          ...
          " href="/admin/trang-thai">
            ...
            <span class="nav-link-text ms-1">Trạng thái</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  
          @if($url == route('banner.index'))
          active
          @endif
          @if($url == route('banner.create'))
          active
          @endif
          {{-- @if($url == route('quan-ly-bai-viet.da-xoa'))
          active
        ...
        <li class="nav-item">
          <a class="nav-link  " href="admin/dang-nhap">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
